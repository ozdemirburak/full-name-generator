const finnishSurnames = [ // https://www.avoindata.fi/data/en_GB/dataset/none
    ...
    'Ojala','Leppänen','Kallio','Leinonen','Väisänen','Hiltunen','Pitkänen','Miettinen','Manninen','Aaltonen',
    'Koivisto','Hakala','Anttila','Laaksonen','Hirvonen','Lehto','Räsänen','Laakso','Toivonen','Rantala',
];
