export const names: Names = {
    ...
    'cz': {
        0: [ // https://web.archive.org/web/20231013180621/https://www.czso.cz/documents/10180/127713060/tabulka_s_celkovym_poradim_2019.xlsx/43178ee7-0379-44e5-9997-850b5cf8476c?version=1.0
            'Jakub', 'Jan', 'Tomáš', 'Matyáš', 'Adam', 'Filip', 'Vojtěch', 'Lukáš', 'Martin', 'Matěj',
            'Ondřej', 'Daniel', 'David', 'Dominik', 'Antonín', 'Michal', 'Petr', 'Štěpán', 'Tobiáš', 'Marek',
            'Samuel', 'Jiří', 'Václav', 'Šimon', 'Kryštof', 'Jonáš', 'Mikuláš', 'Oliver', 'Tadeáš', 'Patrik',
            'Josef', 'František', 'Jáchym', 'Pavel', 'Viktor', 'Sebastian', 'Karel', 'Eliáš', 'Jaroslav', 'Vít',
            'Matouš', 'Teodor', 'Richard', 'Kristián', 'Michael', 'Eduard', 'Sebastián', 'Maxmilián', 'Jindřich', 'Vilém',
        ],
        1: [ // https://web.archive.org/web/20231013180621/https://www.czso.cz/documents/10180/127713060/tabulka_s_celkovym_poradim_2019.xlsx/43178ee7-0379-44e5-9997-850b5cf8476c?version=1.0
            'Eliška', 'Anna', 'Adéla', 'Tereza', 'Sofie', 'Viktorie', 'Ema', 'Karolína', 'Natálie', 'Amálie',
            'Julie', 'Kristýna', 'Barbora', 'Nela', 'Laura', 'Klára', 'Emma', 'Anežka', 'Rozálie', 'Sára',
            'Marie', 'Lucie', 'Aneta', 'Zuzana', 'Mia', 'Veronika', 'Ella', 'Alžběta', 'Nikola', 'Gabriela',
            'Kateřina', 'Nikol', 'Valerie', 'Magdaléna', 'Nina', 'Liliana', 'Ester', 'Elena', 'Josefína', 'Adriana',
            'Markéta', 'Štěpánka', 'Stella', 'Magdalena', 'Stela', 'Beáta', 'Terezie', 'Linda', 'Jasmína', 'Emily'
        ]
    },
    'it': {
    ...
    'tr': {
        0: [ // https://web.archive.org/web/20231011175540/https://www.nvi.gov.tr/kurumlar/nvi.gov.tr/Genel_Mudurluk/istatistikler/En_cok_Kullanilan_Ad_Istatistigi.pdf
    ...
    'us': {
        0: [ // https://web.archive.org/web/20231007032325/https://www.ssa.gov/oact/babynames/
        ...
        1: [ // https://web.archive.org/web/20231007032325/https://www.ssa.gov/oact/babynames/
