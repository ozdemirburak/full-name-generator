const portugueseNames = {
    ...
    1: [ // https://web.archive.org/web/20231016204629/https://pt.wikipedia.org/wiki/Antropon%C3%ADmia_da_l%C3%ADngua_portuguesa
        'Alexandra', 'Alice', 'Amélia', 'Ana', 'Bárbara', 'Bianca', 'Camila', 'Carlota', 'Carolina', 'Cecília',
        'Cláudia', 'Cristina', 'Daniela', 'Diana', 'Elisabete', 'Elvira', 'Emília', 'Fernanda', 'Filipa', 'Francisca',
        'Gabriela', 'Helena', 'Inês', 'Isabel', 'Jéssica', 'Joana', 'Juliana', 'Laura', 'Leonor', 'Lídia',
        'Lígia', 'Liliana', 'Lorena', 'Luísa', 'Lúcia', 'Madalena', 'Magda', 'Manuela', 'Margarida', 'Maria',
        'Mariana', 'Micaela', 'Rita', 'Rosa', 'Sofia', 'Susana', 'Teresa', 'Vanessa', 'Vera', 'Vitória'
    ]
}
